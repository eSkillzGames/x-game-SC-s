...
contract Tournaments is Ownable {
    ...
    constructor (address addr) public { cue = IERC20(addr); aFee = 0; pFee = 0; cFee = 0; eskillz_fee = 0; prize1 = 50; prize2 = 30; prize3 = 20;}
    ...
    function setTableFee(uint256 _aFee, uint256 _pFee, uint256 _cFee) public {
        aFee = _aFee; pFee = _pFee; cFee = _cFee;
    }
    function getTableFee() public view returns(uint256, uint256, uint256) {
        return (aFee,pFee,cFee);
    }
    function setTablePrice(uint256 _aPrice, uint256 _pPrice, uint256 _cPrice) public {
        aPrice = _aPrice;
        pPrice = _pPrice;
        cPrice = _cPrice;
    }
    ...
    function setEntryFee(uint256 _entry_fee) public {
        entryFee = _entry_fee;
    }
}
